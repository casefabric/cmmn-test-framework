...
// This test verifies that when a case task fails in a sub case, and the fault is handled in the sub case, the parent case task will also be marked as completed (and not failed).
